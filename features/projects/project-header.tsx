      ...
      <div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div className="rounded-lg border border-border bg-muted/50 p-4">
            <h3 className="mb-2 font-semibold text-card-foreground">Technology Stack</h3>
          ...
          <div className="rounded-lg border border-border bg-muted/50 p-4">
            <h3 className="mb-2 font-semibold text-card-foreground">Responsive Design</h3>
            <p className="text-sm text-muted-foreground">
          ...
          {project.status === 'completed' && (
            <div className="rounded-lg border border-border bg-muted/50 p-4">
              <h3 className="mb-2 font-semibold text-card-foreground">Production Ready</h3>
              <p className="text-sm text-muted-foreground">
          ...
          {project.liveUrl && (
            <div className="rounded-lg border border-border bg-muted/50 p-4">
              <h3 className="mb-2 font-semibold text-card-foreground">Live & Interactive</h3>
              <p className="text-sm text-muted-foreground">
