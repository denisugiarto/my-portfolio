      ...
      <section id="projects" className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none opacity-50">
          ...
          >
            ...
            <m.rect
              x="100" y="200" width="120" height="80" rx="8"
            ...
            <m.rect
              x="700" y="500" width="150" height="90" rx="12"
            ...
            <m.rect
              x="300" y="100" width="200" height="120" rx="10"
...
export function AnimatedProjectSection({ children, delay = 0.5 }: AnimatedSectionProps) {
  return (
    <m.div
