...
export default function ProjectCard({
  ...
  return (
    <m.div
      className="group overflow-hidden border-[3px] border-foreground bg-card shadow-[4px_4px_0px_0px_hsl(var(--foreground))] transition-all duration-150 hover:-translate-x-[4px] hover:-translate-y-[4px] hover:shadow-[8px_8px_0px_0px_hsl(var(--foreground))]"
