                        ...
                        <div className="flex flex-col gap-4 sm:flex-row xl:items-start xl:justify-between">
                          <div className="flex flex-1 items-start gap-3 md:gap-4">
                            ...
                            <div className="min-w-0 flex-1 space-y-2 md:space-y-3">
                              ...
                              <h3 className="text-xl font-black uppercase leading-tight tracking-tight text-primary-foreground sm:text-2xl md:text-3xl inline-block bg-primary px-2 py-1 shadow-[3px_3px_0px_0px_hsl(var(--foreground))] md:shadow-[4px_4px_0px_0px_hsl(var(--foreground))] border-[3px] md:border-4 border-foreground">
                                {experience.jobTitle}
                              </h3>
