  ...
  try {
    ...
    if (
      ...
      return NextResponse.json(
        {
          message:
            "A message with similar content was recently submitted. Please wait before sending another.",
    ...
    return NextResponse.json(
      {
        message:
          "Sorry, there was an error processing your message. Please try again or contact me directly.",
        error: "SERVER_ERROR",
      },
      { status: 500 },
    );
