...
export function getAccessibleColor(
  ...
  while (
    !meetsContrastRequirement(adjustedColor, background, level) &&
...
export function useAccessibleColorForContext(
  ...
  useEffect(() => {
    ...
    const updateColor = () => {
      setAccessibleColor(
        getAccessibleColorForContext(originalColor, context, level),
      );
    };
